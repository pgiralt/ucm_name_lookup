---
trigger: glob
globs: **/*.bash,**/*.c,**/*.cls,**/*.ddl,**/*.dml,**/*.go,**/*.h,**/*.htm,**/*.html,**/*.java,**/*.js,**/*.jsx,**/*.mjs,**/*.php,**/*.ps1,**/*.py,**/*.pyi,**/*.pyx,**/*.rb,**/*.sh,**/*.sql,**/*.trigger,**/*.ts,**/*.tsx
title: Input validation and injection defense (SQL/SOQL/LDAP/OS), parameterization, prototype pollution
version: 1.2.0
---
